...
5. Analyze content strictly adhering to `STYLE.md` (Pyramid Principle, bullet points, rigorous tone).
6. Send the results in Telegram containing title, description, 3-bullet point summary and link.

## Quality Gate
Every report must conclude with an explicit one-line verdict:
- "High ROI"
- "Medium ROI"
- "Low ROI, skip it."
